Rails.application.routes.draw do
  ...
  constraints(ChannelSubdomains) do
    ...
    resources :surveys, param: :slug do
      resources :interviewers, controller: "surveys/interviewers"
